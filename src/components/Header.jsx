...
function Header() {
    ...
    return (
        <div className='bg-[#334B35] py-6 h-full overflow-hidden text-white flex items-center justify-between p-4 relative'>
            ...
            <div className={`fixed top-0 right-0 h-full w-2/3 max-w-xs bg-[#334B35] text-white transform ${isMenuOpen ? 'translate-x-0 z-50' : 'translate-x-full'} transition-transform duration-300 ease-in-out md:hidden`}>
